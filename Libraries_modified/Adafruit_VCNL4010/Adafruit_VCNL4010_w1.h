...
typedef enum
  {
    VCNL4010_1_95_w1    = 0, // 1.95     measurements/sec (Default)
    VCNL4010_3_90625_w1 = 1, // 3.90625  measurements/sec
    VCNL4010_7_8125_w1  = 2, // 7.8125   measurements/sec
    VCNL4010_16_625_w1  = 3, // 16.625   measurements/sec
    VCNL4010_31_25_w1   = 4, // 31.25    measurements/sec
    VCNL4010_62_5_w1    = 5, // 62.5     measurements/sec
    VCNL4010_125_w1     = 6, // 125      measurements/sec
    VCNL4010_250_w1     = 7, // 250      measurements/sec
  } vcnl4010_freq_w1;
...
*/
/**************************************************************************/
class Adafruit_VCNL4010_w1 {
  public:
    Adafruit_VCNL4010_w1();
    boolean begin(uint8_t a = VCNL4010_I2CADDR_DEFAULT, TwoWire *theWire = &Wire1);

    uint8_t getLEDcurrent(void);
    void setLEDcurrent(uint8_t c);

    void setFrequency(vcnl4010_freq_w1 f);
