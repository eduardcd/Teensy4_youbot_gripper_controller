...
*/
/**************************************************************************/
Adafruit_VCNL4010_w1::Adafruit_VCNL4010_w1() {
}
...
*/
/**************************************************************************/
boolean Adafruit_VCNL4010_w1::begin(uint8_t addr, TwoWire *theWire) {
  _i2caddr = addr;
  _wire = theWire;
  _wire->begin();
  _wire->setSCL(16);
  ...
  setFrequency(VCNL4010_16_625_w1); // 16.625 readings/second
...
void Adafruit_VCNL4010_w1::setLEDcurrent(uint8_t current_10mA) {
...
uint8_t Adafruit_VCNL4010_w1::getLEDcurrent(void) {
...
void Adafruit_VCNL4010_w1::setFrequency(vcnl4010_freq_w1 freq) {
...
uint16_t  Adafruit_VCNL4010_w1::readProximity(void) {
...
uint16_t  Adafruit_VCNL4010_w1::readAmbient(void) {
  uint8_t i = read8(VCNL4010_INTSTAT);
  i &= ~0x40;
  write8(VCNL4010_INTSTAT, i);
...
uint8_t Adafruit_VCNL4010_w1::read8(uint8_t address)
{
  uint8_t data;
...
uint16_t Adafruit_VCNL4010_w1::read16(uint8_t address)
{
  uint16_t data;
...
// write 1 byte
void Adafruit_VCNL4010_w1::write8(uint8_t address, uint8_t data)
{
  _wire->beginTransmission(_i2caddr);
#if ARDUINO >= 100
  _wire->write(address);
